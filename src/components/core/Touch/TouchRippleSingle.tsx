...
import {TouchSingleProps, TouchSingle} from './TouchSingle';
...
export const TouchRippleSingle = React.memo(
  React.forwardRef<TouchRippleSingleMethods, TouchRippleSingleProps>(
    (props, ref) => {

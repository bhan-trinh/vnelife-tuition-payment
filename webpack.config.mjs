  ...
  return {
      ...
      rules: [
        {
          ...
          include: [
            ...
            /node_modules(.*[/\\])+vnpt-rn-component/,
            // /node_modules(.*[/\\])+react-native-portalize/,
            /node_modules(.*[/\\])+pmn-vnpt-componentkits/,
    ...
    plugins: [
      ...
      new Repack.plugins.ModuleFederationPlugin({
        name: "com.miniapp.dia_chi_so",
        exposes: {
          "./dia_chi_so_module": "./src/com_miniapp_dia_chi_so.tsx",
        },
        shared: {
          react: {
